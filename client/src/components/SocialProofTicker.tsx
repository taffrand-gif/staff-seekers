...
const actionsNorte = [
  ...
  'pediu orçamento para reparação de autoclismo',
  ...
  'pediu orçamento para reparação de sifão',
  ...
  'pediu orçamento para reparação de torneira com fuga',
];

const actionsStaff = [
  'pediu orçamento para quadro elétrico',
  'ligou para curto-circuito urgente',
  'pediu certificação CERTIEL para venda de imóvel',
  ...
  'pediu certificação CERTIEL para alojamento local',
  'agendou instalação de videoporteiro',
  'pediu orçamento para reparação de campainha',
