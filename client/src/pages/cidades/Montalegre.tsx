...
export default function Montalegre() {
  useEffect(() => {
    document.title = "Electricista Montalegre 24h - Barragens e Pecuária Barroso - +351 932 321 892";
    ...
    metaDescription.setAttribute('content', 'Electricista em Montalegre. Instalações para barragens, explorações pecuárias do Barroso e habitações de montanha. Veículo 4x4. Orçamento gratuito.');
    ...
    canonical.setAttribute('href', 'https://staff-seekers.com/electricista-montalegre');
    ...
    schemaScript.text = JSON.stringify({
      ...
      "@type": "Electrician",
      "name": "Electricista Profissional Montalegre",
      "description": "Electricista profissional em Montalegre. Especialista em instalações de montanha e explorações do Barroso.",
      "address": {
        "@type": "PostalAddress",
      ...
      <main className="flex-grow">
        <section className="relative py-20 bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/images-optimized/hero/hero-electrician-portugal.jpg')` }}>
          <div className="container text-center text-white">
            ...
            <h1 className="text-4xl md:text-6xl font-black mb-6">Electricista em Montalegre</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/351932321892?text=Olá,%20preciso%20de%20um%20eletricista%20em%20Montalegre" className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg text-xl font-bold transition-all shadow-lg">💬 WhatsApp</a>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-orange-500 text-white">
          <div className="container text-center">
            <h2 className="text-3xl font-black mb-4">Precisa de Electricista em Montalegre?</h2>
        ...
        <RelatedCities currentCity="Montalegre" currentCitySlug="electricista-montalegre" />
      </main>
      <Footer />
    </div>
  );
