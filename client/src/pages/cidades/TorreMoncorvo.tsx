// SEO optimized page for "Electricista Torre de Moncorvo"
...
export default function TorreMoncorvo() {
  useEffect(() => {
    document.title = "Electricista Torre de Moncorvo 24h - Urgências Elétricas - +351 932 321 892";
    ...
    metaDescription.setAttribute('content', 'Electricista em Torre de Moncorvo disponível 24h. Reparação de avarias elétricas, quadros elétricos, certificação. Servimos todo o concelho. Orçamento gratuito.');
    ...
    canonical.setAttribute('href', 'https://staff-seekers.com/electricista-torre-moncorvo');
    ...
    schemaScript.text = JSON.stringify({
      ...
      "@type": "Electrician",
      "name": "Electricista Profissional Torre de Moncorvo",
      "description": "Electricista profissional em Torre de Moncorvo. Serviço 24h.",
  ...
  const faqs = [
    ...
    { question: "Qual o custo de deslocação?", answer: "A deslocação a Torre de Moncorvo é de 35-40€, dependendo da freguesia." },
      ...
      <main className="flex-grow">
        <section className="relative py-20 bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/images-optimized/hero/hero-electrician-portugal.jpg')` }}>
          <div className="container text-center text-white">
            ...
            <h1 className="text-4xl md:text-6xl font-black mb-6">Electricista em Torre de Moncorvo</h1>
        ...
        <section className="py-16 bg-orange-500 text-white">
          <div className="container text-center">
            <h2 className="text-3xl font-black mb-4">Precisa de Electricista em Torre de Moncorvo?</h2>
        ...
        <RelatedCities 
          ...
          currentCitySlug="electricista-torremoncorvo" 
        />
      </main>
      <Footer />
    </div>
