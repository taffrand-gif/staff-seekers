...
export default function Sabrosa() {
  useEffect(() => {
    document.title = "Electricista Sabrosa 24h - Douro e Fernão de Magalhães - +351 932 321 892";
    ...
    metaDescription.setAttribute('content', 'Electricista em Sabrosa, terra de Fernão de Magalhães no Douro. Instalações para quintas, museus e turismo. Quadros elétricos, certificação. Orçamento gratuito.');
    ...
    canonical.setAttribute('href', 'https://staff-seekers.com/electricista-sabrosa');
    ...
    schemaScript.text = JSON.stringify({
      ...
      "@type": "Electrician",
      "name": "Electricista Profissional Sabrosa",
      "description": "Electricista profissional em Sabrosa. Instalações para quintas do Douro e espaços culturais.",
      "address": {
        "@type": "PostalAddress",
      ...
      <main className="flex-grow">
        <section className="relative py-20 bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/images-optimized/hero/hero-electrician-portugal.jpg')` }}>
          <div className="container text-center text-white">
            ...
            <h1 className="text-4xl md:text-6xl font-black mb-6">Electricista em Sabrosa</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/351932321892?text=Olá,%20preciso%20de%20um%20eletricista%20em%20Sabrosa" className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg text-xl font-bold transition-all shadow-lg">💬 WhatsApp</a>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-orange-500 text-white">
          <div className="container text-center">
            <h2 className="text-3xl font-black mb-4">Precisa de Electricista em Sabrosa?</h2>
        ...
        <RelatedCities currentCity="Sabrosa" currentCitySlug="electricista-sabrosa" />
      </main>
      <Footer />
    </div>
  );
